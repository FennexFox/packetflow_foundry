...
Use this file for the shared evaluation-log envelope in `gh-address-review-threads`.
...
`<repo-root>/.codex/tmp/evaluation_logs/gh-address-review-threads/<run-id>.json`
