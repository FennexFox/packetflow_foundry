...
Use the shared evaluation envelope in [evaluation-log-contract.md](/C:/Users/techn/source/repos/FennexFox/packetflow_foundry/.agents/skills/gh-create-pr/references/evaluation-log-contract.md) and keep create-specific metrics under `skill_specific.data`.
